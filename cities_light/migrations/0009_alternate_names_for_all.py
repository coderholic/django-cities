...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cities_light_country', 'alternate_names',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Region.alternate_names'
        db.add_column('cities_light_region', 'alternate_names',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('cities_light_country', 'alternate_names')

        # Deleting field 'Region.alternate_names'
        db.delete_column('cities_light_region', 'alternate_names')
