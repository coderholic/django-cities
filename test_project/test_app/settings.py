...
if travis_commit and travis_repo_slug:
    url_base = 'https://raw.githubusercontent.com/%s/%s/test_project/data/' % (travis_repo_slug, travis_commit)
else:

    url_base = "https://raw.githubusercontent.com/%s/master/test_project/data/" % (travis_repo_slug or 'coderholic/django-cities')
